...
- 真实地图展示 57 个小区位置光斑：贝壳已有房源使用青绿色实线光斑，高德补充候选使用暖黄色虚线光斑；光斑随缩放自适应，不再把相邻小区聚合成一个数字圆点，也不代表小区真实边界。
...
- 数据说明：采集日期 2026-08-24、库存可能变化；无追踪、无 Cookie、无密钥。
...
- 库存与租金为 **2026-08-24 快照**，动态库存可能变化，以贝壳页面实时为准。
